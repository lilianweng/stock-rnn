...
# The repo "github.com/datasets/s-and-p-500-companies" has info about S & P 500 companies.
SP500_LIST_URL = "https://raw.githubusercontent.com/datasets/s-and-p-500-companies/master/" \
...
def _download_sp500_list():
    ...
    content = urllib.request.urlopen(SP500_LIST_URL)
...
def fetch_prices(symbol, out_name):
    ...
    try:
        content = urllib.request.urlopen(symbol_url)
